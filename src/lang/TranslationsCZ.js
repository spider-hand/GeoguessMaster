export default {
  en: {
    Home: {
      ...
      about: 'O HŘE',
      aboutDescription: 'Geoguess Master je jednoduchá geoguess hra zdarma a bez reklam. \
    ...
    CardRoomTime: {
      title: 'Zvol časové omezení kola.',
      next: 'DALŠÍ',
      cancel: 'ZRUŠIT',
    ...
    DialogRoom: {
      ...
      invalidRoomName: 'Neplatné jméno, zvol prosím jiné.',
      inProgress: 'Správce místnosti právě vytvráří novou hru. Počkej prosím chvilku a pak to zkus znovu.',
      roomIsFull: 'Tato místnost je již plná. Počkej prosím chvíli a pak to zkus znovu.',
    },
    DialogSummary: {
      exit: 'UKONČIT',
